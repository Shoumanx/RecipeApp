                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      OBFieldFormProfile('Name'),
                      OBFieldFormProfileNumber('Age'),
                      SizedBox(height: 5.h,),
                      Row(children: [
                        Radio(value: gender[0], groupValue: currentgender, onChanged: (value){
                          currentgender = value.toString();
                        },
                        activeColor: Male,fillColor: MaterialStatePropertyAll(Male)),
                        OBProfileRadio('Male',Male),
                        Radio(value: gender[1], groupValue: currentgender, onChanged: (value){
                          currentgender = value.toString();
                        },
